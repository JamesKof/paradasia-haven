      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl text-foreground mb-6">
            Adventures in
            <span className="text-gold-gradient block">Paradise</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative">
            ...
            {/* Decorative Element */}
            <div className="absolute -bottom-4 -left-4 w-32 h-32 border-2 border-gold/20 rounded-full -z-10" />
          ...
          <div>
            <div className="space-y-6">
              {experiences.map((exp, index) => (
                <div
                  key={exp.title}
                  className="group flex gap-5 p-5 bg-card rounded-xl border border-border hover:border-gold/30 transition-all duration-300 shadow-elevation-1 hover:shadow-elevation-3"
                >
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-gold-dark to-gold flex items-center justify-center shrink-0 group-hover:shadow-gold-glow transition-shadow duration-300">
                    <exp.icon className="w-7 h-7 text-deep-blue" />
                  </div>
                  <div>
                    <h3 className="font-display text-foreground text-lg mb-1 group-hover:text-gold transition-colors duration-300">
                      {exp.title}
                    </h3>
        ...
        {/* Highlight Banner */}
        <div className="relative rounded-2xl overflow-hidden bg-deep-blue p-8 md:p-12 shadow-elevation-5">
          <div className="relative z-10 text-center">
            <h3 className="font-display text-2xl md:text-3xl text-gold-light mb-4">
              Romantic & Adventure Packages Available
            </h3>
            <p className="text-gold-muted/80 mb-6 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button variant="gold">Romantic Getaway</Button>
